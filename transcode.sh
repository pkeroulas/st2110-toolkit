...
TRANSCODER_VIDEO_CPU_ENCODE_OPTIONS_IPTV="-s 1280x720 -pix_fmt yuv420p -c:v libx264 -profile:v main -preset fast -level:v 3.1 -b:v 2500k -x264-params b-pyramid=1 -g 30 -keyint_min 16 -pass 1 -refs 6"
